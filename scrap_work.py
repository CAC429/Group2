...
class MainWindow(QWidget):
    def __init__(self):
        ...
        #self.master_timer.timeout.connect(self.uiscript.py)
        ...
        self.suggested_authority_label = QLabel(f"Suggested Authority: {self.suggested_authority} m")
        self.suggested_speed_label = QLabel(f"Suggested Speed: {self.suggested_speed} mph")

        layout.addWidget(self.suggested_authority_label)
        layout.addWidget(self.suggested_speed_label)
    ...
    def read_wc_inputs(self, file_path='WC_inputs.csv'):
        try:
            ...
            self.suggested_authority_label.setText(f"Suggestd Authority: {self.suggested_authority} m")
            self.suggested_speed_label.setText(f"Suggested Speed: {self.suggested_speed} mph")

            print(f"Suggested Authority: {self.suggested_authority}, Suggested Speed: {self.suggested_speed}")
